...
### Подготовка
Перед началом выполнения всех заданий, был создан [проект](https://github.com/S1GARETA/UnityLab1/tree/main/Practice%201) Unity на версии __2021.3.10f1__ с меню, где были 3 кнопки для каждого задания. Сделано это было с целью, чтобы удобнее переключаться между заданиями, так как для каждого задания была создана отдельная сцена.
...
Дальше, для объекта Sphere был написан [скрипт SphereCollisions](https://github.com/S1GARETA/UnityLab1/blob/main/Practice%201/Assets/Scripts/SphereCollisions.cs). Работа которого, заключается в том, что при столкновении с объектом Cube в консоль выводилось сообщение, что произошло столкновение. И Cube менял цвет с красного на зелёный, когда произошло столкновение и обратно на красный, когда оно завершилось.
