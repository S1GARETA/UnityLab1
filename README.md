...
### Подготовка
Перед началом выполнения всех заданий, был создан [проект](https://github.com/S1GARETA/UnityLab1/tree/main/Practice%201) Unity на версии __2021.3.10f1__ с меню, где были 3 кнопки для каждого задания. Сделано это было с целью удобнее переключаться между заданиями, так как для каждого задания была создана отдельная сцена.
